        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (this.mCursor != null) {
                    r0 = new SimpleCursorAdapter(this.mContext, layout, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
                } else if (this.mAdapter != null) {
                    r0 = this.mAdapter;
                } else {
                    r0 = new CheckedItemAdapter(this.mContext, layout, 16908308, this.mItems);
                }
            } else if (this.mCursor == null) {
                r0 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                ...
                AnonymousClass2 r1 = new CursorAdapter(this.mContext, this.mCursor, false) {
