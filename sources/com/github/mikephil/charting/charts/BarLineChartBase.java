...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void calcMinMax() {
        ...
        this.mAxisLeft.calcMinMax(((BarLineScatterCandleBubbleData) this.mData).getYMin(AxisDependency.LEFT), ((BarLineScatterCandleBubbleData) this.mData).getYMax(AxisDependency.LEFT));
        this.mAxisRight.calcMinMax(((BarLineScatterCandleBubbleData) this.mData).getYMin(AxisDependency.RIGHT), ((BarLineScatterCandleBubbleData) this.mData).getYMax(AxisDependency.RIGHT));
    }
    ...
    public void setVisibleXRange(float minXRange, float maxXRange) {
        ...
        this.mViewPortHandler.setMinMaxScaleX(minScale, this.mXAxis.mAxisRange / minXRange);
    }
    ...
    public void moveViewToX(float xIndex) {
        addViewportJob(new MoveViewJob(this.mViewPortHandler, xIndex, 0.0f, getTransformer(AxisDependency.LEFT), this));
    }
    ...
    public void centerViewTo(float xIndex, float yValue, AxisDependency axis) {
        ...
        addViewportJob(new MoveViewJob(this.mViewPortHandler, xIndex - (xsInView / 2.0f), ((getDeltaY(axis) / this.mViewPortHandler.getScaleY()) / 2.0f) + yValue, getTransformer(axis), this));
    }
    ...
    public void centerViewToAnimated(float xIndex, float yValue, AxisDependency axis, long duration) {
        if (VERSION.SDK_INT >= 11) {
            PointD bounds = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axis);
            float xsInView = ((float) getXAxis().getValues().size()) / this.mViewPortHandler.getScaleX();
            addViewportJob(new AnimatedMoveViewJob(this.mViewPortHandler, xIndex - (xsInView / 2.0f), ((getDeltaY(axis) / this.mViewPortHandler.getScaleY()) / 2.0f) + yValue, getTransformer(axis), this, (float) bounds.x, (float) bounds.y, duration));
            return;
        }
