        ...
        while (j < count) {
            ...
            if (xIndex >= minx && xIndex < maxx) {
                ...
                if (showCandleBar) {
                    ...
                    int barColor = open > close ? dataSet.getDecreasingColor() == 1122867 ? dataSet.getColor(j) : dataSet.getDecreasingColor() : open < close ? dataSet.getIncreasingColor() == 1122867 ? dataSet.getColor(j) : dataSet.getIncreasingColor() : dataSet.getNeutralColor() == 1122867 ? dataSet.getColor(j) : dataSet.getNeutralColor();
