...
public abstract class RealmBaseDataSet<T extends RealmObject, S extends Entry> extends BaseDataSet<S> {
    ...
    public S getEntryForXIndex(int xIndex, Rounding rounding) {
    ...
    public int getEntryIndex(int x, Rounding rounding) {
        ...
        if (closest != -1) {
            ...
            } else if (rounding == Rounding.DOWN && closestXIndex > x && closest > 0) {
                closest--;
            }
        }
        return closest;
    ...
    public void addEntryOrdered(S e) {
        if (e != null) {
            ...
            this.mValues.add(getEntryIndex(e.getXIndex(), Rounding.UP), e);
        }
    }
