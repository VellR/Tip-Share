...
public interface zzug extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzug {
        ...
        private static class C0046zza implements zzug {
        ...
        public static zzug asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzug)) ? new C0046zza(iBinder) : (zzug) queryLocalInterface;
        }
