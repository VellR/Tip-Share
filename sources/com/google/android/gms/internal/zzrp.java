...
public interface zzrp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrp {
        ...
        /* renamed from: com.google.android.gms.internal.zzrp$zza$zza reason: collision with other inner class name */
        private static class C0042zza implements zzrp {
        ...
        public static zzrp zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrp)) ? new C0042zza(iBinder) : (zzrp) queryLocalInterface;
        }
