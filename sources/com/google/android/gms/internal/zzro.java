...
public interface zzro extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzro {
        ...
        /* renamed from: com.google.android.gms.internal.zzro$zza$zza reason: collision with other inner class name */
        private static class C0041zza implements zzro {
        ...
        public static zzro zzdz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzro)) ? new C0041zza(iBinder) : (zzro) queryLocalInterface;
        }
