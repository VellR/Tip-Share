...
public final class zzamt {
    ...
    private void zza(String str, int i, int i2, List<zzanl> list) {
        ...
        list.add(zzanj.zza(zzaoo.zzr(Date.class), (Object) zzamn));
        list.add(zzanj.zza(zzaoo.zzr(Timestamp.class), (Object) zzamn));
        list.add(zzanj.zza(zzaoo.zzr(java.sql.Date.class), (Object) zzamn));
    }
