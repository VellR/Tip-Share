...
public interface zzql extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzql {
        ...
        /* renamed from: com.google.android.gms.internal.zzql$zza$zza reason: collision with other inner class name */
        private static class C0039zza implements zzql {
        ...
        public static zzql zzdn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzql)) ? new C0039zza(iBinder) : (zzql) queryLocalInterface;
        }
