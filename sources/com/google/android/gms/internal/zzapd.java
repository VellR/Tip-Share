...
public final class zzapd {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        if (obj != null) {
            if (obj instanceof zzapc) {
                ...
                if (str != null) {
                    stringBuffer2.append(stringBuffer).append(zzth(str)).append(" <\n");
                    stringBuffer.append("  ");
                }
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(zzfz((String) obj)).append("\"");
    ...
    public static <T extends zzapc> String zzg(T t) {
        if (t == null) {
            return "";
        }
    ...
    private static String zzib(String str) {
