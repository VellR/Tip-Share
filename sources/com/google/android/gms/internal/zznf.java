...
public interface zznf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznf {
        ...
        private static class C0037zza implements zznf {
            ...
            public void zzfo(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.auth.api.internal.IAuthCallbacks");
        ...
        public static zznf zzcg(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.internal.IAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznf)) ? new C0037zza(iBinder) : (zznf) queryLocalInterface;
        }
    ...
    void zzfo(String str) throws RemoteException;
}
