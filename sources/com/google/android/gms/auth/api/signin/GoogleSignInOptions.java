...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional {
    ...
    public Account aP;
    /* access modifiers changed from: private */
    public final ArrayList<Scope> dS;
    /* access modifiers changed from: private */
    public boolean dT;
    /* access modifiers changed from: private */
    ...
    public static final class Builder {
        ...
        private String zzfs(String str) {
            zzab.zzhs(str);
            zzab.zzb(this.dW == null || this.dW.equals(str), (Object) "two different server client ids provided");
            return str;
        }
        ...
        public GoogleSignInOptions build() {
            ...
            return new GoogleSignInOptions((Set) this.dY, this.aP, this.dT, this.dU, this.dV, this.dW, this.dX);
        }
