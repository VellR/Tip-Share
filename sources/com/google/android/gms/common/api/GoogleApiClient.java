...
public abstract class GoogleApiClient {
    ...
    public static final Set<GoogleApiClient> rM = Collections.newSetFromMap(new WeakHashMap());
    ...
    public static final class Builder {
        ...
        private GoogleApiClient zzaof() {
            ...
            for (Api api4 : this.rT.keySet()) {
                Object obj = this.rT.get(api4);
                int i = 0;
                if (zzash.get(api4) != null) {
                    i = ((zza) zzash.get(api4)).yc ? 1 : 2;
                }
                arrayMap.put(api4, Integer.valueOf(i));
                zzpu zzpu = new zzpu(api4, i);
                arrayList.add(zzpu);
                if (api4.zzanq()) {
                    zzh zzano = api4.zzano();
                    Api api5 = zzano.getPriority() == 1 ? api4 : api3;
                    zza = zza(zzano, obj, this.mContext, this.zzahv, zzaoe, (ConnectionCallbacks) zzpu, (OnConnectionFailedListener) zzpu);
                    api = api5;
                } else {
                    Api.zza zzann = api4.zzann();
                    Api api6 = zzann.getPriority() == 1 ? api4 : api3;
                    zza = zza(zzann, obj, this.mContext, this.zzahv, zzaoe, (ConnectionCallbacks) zzpu, (OnConnectionFailedListener) zzpu);
                    api = api6;
                }
                arrayMap2.put(api4.zzanp(), zza);
                if (!zza.zzafz()) {
                    api4 = api2;
                } else if (api2 != null) {
