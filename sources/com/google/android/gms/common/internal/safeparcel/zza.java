...
public class zza {
    ...
    public static class C0008zza extends RuntimeException {
        public C0008zza(String str, Parcel parcel) {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            throw new C0008zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i2).append(" got ").append(zza).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            throw new C0008zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i3).append(" got ").append(i2).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    public static int zzcl(Parcel parcel) {
        int zzck = zzck(parcel);
        int zza = zza(parcel, zzck);
        int dataPosition = parcel.dataPosition();
        if (zzgi(zzck) != 20293) {
            String str = "Expected object header. Got 0x";
            String valueOf = String.valueOf(Integer.toHexString(zzck));
            throw new C0008zza(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), parcel);
        }
        int i = dataPosition + zza;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C0008zza("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
