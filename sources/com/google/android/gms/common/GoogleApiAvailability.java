...
public class GoogleApiAvailability extends zzc {
    ...
    public boolean zza(Activity activity, @NonNull zzqp zzqp, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza = GooglePlayServicesUtil.zza(i, activity, com.google.android.gms.common.internal.zzi.zza(zzqp, zza((Context) activity, i, "d"), i2), onCancelListener);
        if (zza == null) {
            return false;
        }
