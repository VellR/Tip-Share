...
public class zzb {
    ...
    private zzb() {
        ...
        String str2 = (String) zza.Aj.get();
        this.zZ = str2 == null ? Collections.EMPTY_LIST : Arrays.asList(str2.split(","));
        String str3 = (String) zza.Ak.get();
        this.Aa = str3 == null ? Collections.EMPTY_LIST : Arrays.asList(str3.split(","));
        String str4 = (String) zza.Al.get();
        this.Ab = str4 == null ? Collections.EMPTY_LIST : Arrays.asList(str4.split(","));
    ...
    private boolean zzb(String str, String str2, String str3, String str4) {
        return !this.zY.contains(str) && !this.zZ.contains(str2) && !this.Aa.contains(str3) && !this.Ab.contains(str4) && (!str3.equals(str) || (getLogLevel() & zzd.As) == 0);
    }
