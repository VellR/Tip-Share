...
public class zza implements Creator<Field> {
    static void zza(Field field, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 9, (Parcelable) field.zzaub(), i, false);
        ...
        while (parcel.dataPosition() < zzcl) {
            ...
            switch (com.google.android.gms.common.internal.safeparcel.zza.zzgi(zzck)) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    converterWrapper = (ConverterWrapper) com.google.android.gms.common.internal.safeparcel.zza.zza(parcel, zzck, (Creator<T>) ConverterWrapper.CREATOR);
                    break;
                default:
